...
class MainViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    @IBOutlet weak var card01CompanyUrlLabel: UILabel!
    ...
    @IBOutlet weak var card02CompanyUrlLabel: UILabel!
...
//        userSettingList = UDSetting.returnSetValue()
        ...
        appealLabel.text = userInfo.selfAppeal
